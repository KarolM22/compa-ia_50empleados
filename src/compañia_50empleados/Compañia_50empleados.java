/*
 * 9.	Una compañía ha tenido un excelente año y 
desea premiar a sus empleados con un aumento de salarios. 
...
imprima el nombre, el sueldo actual y el sueldo aumentado. Al final de la 
lista debe proporcionar también, el monto total de la nómina actual y el monto
total de la nueva nómina que incluye los aumentos mencionados.

 */
package compañia_50empleados;
...
public class Compañia_50empleados {
    ...
    public static void main(String[] args) {
        ...
        int salario, aumento=0,nomina=0,NuevaNomina=0;
        ...
        NuevaNomina=NuevaNomina+aumento;
      ...
      for (int j=0;j<50;j++){
        ...
        System.out.println(" NOMINA CON AUMENTO "+NuevaNomina);
